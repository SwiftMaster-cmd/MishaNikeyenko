...
main.innerHTML = `
  ...
  <div style="text-align:center;">
    <button id="run-test-btn" style="padding:10px 36px;border-radius:8px;background:#3d4386;color:#fff;font-size:1.15em;cursor:pointer;border:none;box-shadow:0 2px 6px #15153377;">Run Test Session</button>
  </div>
