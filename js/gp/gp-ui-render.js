// gp-ui-render.js -- Guest Portal UI with nested Step 2 support, hydration on load, and live save
(function(global) {
  // Questions
  ...
  function renderUI() {
    ...
    hydrateAnswers();              // ← hydrate Step 2 (and Step 1/3) from answers
